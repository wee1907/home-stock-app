...
const DEFAULT_CATEGORIES = ['ทั้งหมด', 'ห้องครัว', 'ห้องน้ำ', 'เครื่องสำอาง', 'อื่นๆ'];
const DEFAULT_UNITS = ['ขวด', 'ถุง', 'ก้อน', 'กล่อง', 'กระป๋อง', 'แพ็ค', 'ชิ้น', 'ซอง'];
const DEFAULT_SIZES = ['เล็ก', 'กลาง', 'ใหญ่', 'ถุงเติม', 'ยาว'];
